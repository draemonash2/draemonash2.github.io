...
- 【プッシュ】 `git push`
- 【プル】 `git pull`
- 【フェッチ(取得)】 `git fecth` #→リモートの「master」ブランチ → ローカルの「origin/master」ブランチ
...
- マージ
    ...
    - 【特定コミット取込み(コミットする)】 `git cherry-pick ハッシュ値`
...
- 【[コミットをまとめる](https://riri1904.hatenablog.com/entry/2019/12/21/100000)】
    ...
    3. コミットコメント修正画面にて、先頭を新しいコミットコメント、それ以外を削除する
