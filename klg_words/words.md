...
- ベクトル制御
	...
	- 他の用語
		- dq軸
			- d：磁界成分
			- q：トルク成分
	- [弱め界磁](https://tech.nikkeibp.co.jp/dm/article/WORD/20090916/175328/)
		- 界磁に永久磁石を用いたモータでは永久磁石の磁束が一定なので，回転数が上がるにつれて同磁束によって生じる逆起電力が増加する。そして，ある回転数に達すると，この逆起電力がモータの印加電圧と等しくなる。それにより，モータには電流を流せなくなり，それよりも回転数を上げることができなくなる。これを防ぐために用いるのが弱め界磁。
- [相電流と線間電圧](https://hegtel.com/three-phase-delta.html)
- [三菱電機製ベルト駆動式モータジェネレーター](https://www.giho.mitsubishielectric.co.jp/giho/pdf/2016/1603113.pdf)
