...
|リボン|カテゴリ|Key|機能|
|:---||:---|:---|
|ホーム-配置|セル表示|H L 1 / H A C / H R|文字配置 左右 左/中央/右|
|ホーム-配置|セル表示|H A T / H A M / H A B|文字配置 上下 上/中央/下|
|ホーム-セル|セル表示|H O I / H O A|列/行幅 自動調整|
...
|ホーム-フォント|セル表示|H F G / H F K|フォント サイズ＋＋/－－|
...
|ホーム-数値|セル表示|H 0(zero) / H 9|小数点以下 表示桁数＋＋/－－|
...
|なし|シート操作|O H H / O H U|シート 非表示/再表示|
|なし|セル表示|O D|「条件付き書式ルールの管理」表示|
|データ-データツール|セル操作|A E|「区切り位置」表示|
|データ-アウトライン|セル操作|A H / A J|グループ 折りたたむ/展開|
