...
|リボン|カテゴリ|Key|機能|
|:---|:---|:---|:---|:---|
|ホーム-フォント|★★★★☆|H F F|Home→Font→Font|セル書式 フォント 変更|
|ホーム-フォント|★★★★☆|H F S|Home→Font→Size|セル書式 フォント サイズ変更|
|ホーム-フォント|★★★★★|H F 1|Home→Font→Interior|セル書式 フォント カラー変更|
|ホーム-フォント|★★★★☆|H H|Home→Haikei|セル書式 セル塗りつぶし|
|ホーム-配置|★★★★★|H W|Home→While(全体)|セル書式 文字配置 折り返して全体を表示|
|ホーム-配置|★★★★★|H L 1 / H A C / H R|Home→Left→1、→Align→Right、→Right|セル書式 文字配置 左/中央/右|
|ホーム-配置|★★★★★|H A T / H A M / H A B|Home→Align→Top/Middle/Bottom|セル書式 文字配置 上/中央/下|
|ホーム-フォント|★★★★★|H B N / H B A / H B T|Home→？→Nasi/？/？|セル書式 罫線 なし/格子/太外枠|
|ホーム-配置|★★★☆☆|H M U||セル書式 セル結合 解除|
|ホーム-数値|★★★☆☆|H 0(zero) / H 9||セル書式 小数点以下 表示桁数＋＋/－－|
|なし|★★★☆☆|E A R / E A H||セル書式 ハイパーリンク 削除/クリア|
|なし|★★★☆☆|O D||セル書式 条件付き書式ダイアログ|
|校閲-コメント|★★☆☆☆|R H 1||セル書式 コメント 表示/非表示|
|表示-ウィンドウ|★★★★★|W F F||シート表示 ウィンドウ 枠固定 切り替え|
|表示-表示|★★★★★|W V G||シート表示 枠線 表示/非表示|
|ホーム-セル|★★★★☆|H O I / H O A|Home→fOrmat→|シート表示 列/行幅 自動調整|
|なし|★★★☆☆|O H H / O H U||シート操作 シート非表示/表示|
|なし|★★★☆☆|E L||シート操作 シート削除|
|なし|★★★☆☆|E M||シート操作 シート移動orコピーダイアログ|
|ホーム-セル|★★★☆☆|H O T|Home→Operate→？|シート操作 シート見出しの色|
|なし|★★☆☆☆|I B||シート表示 改ページ挿入|
|データ-データツール|★★★☆☆|A E||データ 区切り位置ダイアログ|
|データ-アウトライン|★★★★☆|A H / A J||データ グループ 折りたたむ/展開|
|データ-データツール|★★★☆☆|A M||データ 重複削除|
|データ-データツール|★★★★☆|D L|Data→？|データ 入力規則ダイアログ|
|ホーム-編集|★★★★☆|H F D O||ツール オブジェクト選択|
|数式-ワークシート分析|★★☆☆☆|M V||ツール 数式の検証|
|校閲-保護|★★☆☆☆|R U 2||ツール ブック共有|
