...
|:---|:---|:---|
|★★★★☆|H F F|セル書式 フォント 変更|
|★★★★☆|H F S|セル書式 フォント サイズ変更|
|★★★★★|H F 1|セル書式 フォント カラー変更|
|★★★★☆|H H|セル書式 セル塗りつぶし|
|★★★★★|H W|セル書式 文字配置 折り返して全体を表示|
|★★★★★|H L 1 / H A C / H R|セル書式 文字配置 左/中央/右|
|★★★★★|H A T / H A M / H A B|セル書式 文字配置 上/中央/下|
|★★★★★|H B N / H B A / H B T|セル書式 罫線 なし/格子/太外枠|
|★★★☆☆|H M U|セル書式 セル結合 解除|
...
|★★★★☆|H O I / H O A|シート表示 列/行幅 自動調整|
|★★★☆☆|H O T|シート操作 シート見出しの色|
