...
|20.356|0|20|20|20|21|20|
|10.123|0|10|10|10|11|10|
|-10.123|0|-11|-10|-10|-11|-10|
|-20.356|0|-21|-20|-20|-21|-20|
|20.356|1|20|20.3|20.3|20.4|20.4|
|10.123|1|10|10.1|10.1|10.2|10.1|
|-10.123|1|-11|-10.1|-10.1|-10.2|-10.1|
|-20.356|1|-21|-20.3|-20.3|-20.4|-20.4|
...
|使用頻度 | Key | 機能 | 覚え方|
|:---|:---|:---|:---|
|★★★★☆|H F F|Home→Font→Font|セル書式 フォント 変更|
|★★★★☆|H F S|Home→Font→Size|セル書式 フォント サイズ変更|
|★★★★★|H F 1|Home→Font→Interior|セル書式 フォント カラー変更|
|★★★★☆|H H|Home→Haikei|セル書式 セル塗りつぶし|
|★★★★★|H W|Home→While(全体)|セル書式 文字配置 折り返して全体を表示|
|★★★★★|H L 1 / H A C / H R|Home→Left→1|セル書式 文字配置 左/中央/右|
|★★★★★|H A T / H A M / H A B|Home→Align→Top/Middle/Bottom|セル書式 文字配置 上/中央/下|
|★★★★★|H B N / H B A / H B T|Home→B罫→Nasi/Amiami/Table|セル書式 罫線 なし/格子/太外枠|
|★★★☆☆|H M U||セル書式 セル結合 解除|
|★★★☆☆|H 0(zero) / H 9||セル書式 小数点以下 表示桁数＋＋/－－|
|★★★☆☆|E A R / E A H||セル書式 ハイパーリンク 削除/クリア|
|★★★☆☆|O D||セル書式 条件付き書式ダイアログ|
|★★☆☆☆|R H 1||セル書式 コメント 表示/非表示|
|★★★★★|W F F||シート表示 ウィンドウ 枠固定 切り替え|
|★★★★★|W V G||シート表示 枠線 表示/非表示|
|★★★★☆|H O I / H O A|Home→fOrmat→|シート表示 列/行幅 自動調整|
|★★★☆☆|H O T|Home→Operate→？|シート操作 シート見出しの色|
|★★★☆☆|O H H / O H U||シート操作 シート非表示/表示|
|★★★☆☆|E L||シート操作 シート削除|
|★★★☆☆|E M||シート操作 シート移動orコピーダイアログ|
|★★☆☆☆|I B||シート表示 改ページ挿入|
|★★★☆☆|A E||データ 区切り位置ダイアログ|
|★★★★☆|A H / A J||データ グループ 折りたたむ/展開|
|★★★☆☆|A M||データ 重複削除|
|★★★★☆|D L|Data→Lule(Rule)|データ 入力規則ダイアログ|
|★★★★☆|H F D O||ツール オブジェクト選択|
|★★☆☆☆|M V||ツール 数式の検証|
|★★☆☆☆|R U 2||ツール ブック共有|
