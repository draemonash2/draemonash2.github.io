...
- リボンに設定
	...
	- 名前の管理
	- オブジェクトの選択
- [オートコレクト抑制](https://forest.watch.impress.co.jp/docs/serial/exceltips/1187/219/index.html)
	- 英単語の頭文字が大文字になったりスペルが自動で修正される
		1. ［ファイル］タブ->「オプション］
		1. ［Excelのオプション］ウィンドウ
			1. ［文章校正］->［オートコレクトのオプション］
		1. ［オートコレクト］ウィンドウ
			1. ［オートコレクト］タブ内の抑制したいチェックボックスを外す
...
|リボン|カテゴリ|Key|機能|
|:---||:---|:---|
|ホーム-配置|セル表示|H L 1|文字配置 左右 左|
|ホーム-配置|セル表示|H A C|文字配置 左右 中央|
|ホーム-配置|セル表示|H R|文字配置 左右 右|
|ホーム-配置|セル表示|H A T|文字配置 上下 上|
|ホーム-配置|セル表示|H A M|文字配置 上下 中央|
|ホーム-配置|セル表示|H A B|文字配置 上下 下|
|ホーム-セル|セル表示|H O I|列幅 自動調整|
|ホーム-セル|セル表示|H O A|行幅 自動調整|
|ホーム-セル|シート|H O T|シート 見出しの色|
|ホーム-フォント|セル表示|H B N|罫線 なし|
|ホーム-フォント|セル表示|H B A|罫線 格子|
|ホーム-フォント|セル表示|H B T|罫線 太外枠|
|ホーム-フォント|セル表示|H F F|フォント 変更|
|ホーム-フォント|セル表示|H F G|フォント サイズ＋＋|
|ホーム-フォント|セル表示|H F K|フォント サイズ－－|
|ホーム-フォント|セル表示|H F S|フォント サイズ変更|
|ホーム-フォント|セル表示|H F C 1|フォント カラー変更|
|ホーム-フォント|セル表示|H H N|セル塗りつぶし なし|
|ホーム-フォント|セル表示|H H|セル塗りつぶし 変更|
|ホーム-編集|セル操作|H F D O|オブジェクト選択|
|ホーム-配置|セル表示|H W|折り返して全体を表示|
|ホーム-配置|セル表示|H M U|セル結合 解除|
|ホーム-数値|セル表示|H 0(zero)|小数点以下 表示桁数＋＋|
|ホーム-数値|セル表示|H 9|小数点以下 表示桁数－－|
|表示-ウィンドウ|ウィンドウ|W F F|ウィンドウ 枠固定 切り替え|
|表示-表示|ウィンドウ|W V G|枠線 表示/非表示|
|なし|シート|E L|シート 削除|
|なし|セル操作|E S|形式を選択して貼り付け|
|なし|シート操作|E M|「シートの移動またはコピー」表示|
|なし|セル表示|E A R|ハイパーリンク 削除|
|なし|セル表示|E A H|ハイパーリンク クリア|
|なし|シート操作|O H H|シート 非表示|
|なし|シート操作|O H U|シート 再表示|
|なし|セル表示|O D|「条件付き書式ルールの管理」表示|
|データ-データツール|セル操作|A E|「区切り位置」表示|
|データ-アウトライン|セル操作|A H|グループ 折りたたむ|
|データ-アウトライン|セル操作|A J|グループ 展開|
|データ-データツール|セル操作|A M|重複削除|
|データ-データツール|セル表示|D L|「データ入力規則」表示|
|なし|シート表示|I B|改ページ挿入|
|校閲-コメント|セル表示|R H 1|コメント 表示/非表示|
|数式-ワークシート分析|セル表示|M V|数式の検証|
|校閲-保護|校閲|R U 2|ブック共有|
